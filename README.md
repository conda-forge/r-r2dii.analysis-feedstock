...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-r2dii.analysis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14430&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-r2dii.analysis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-r2dii.analysis` can be installed with:

```
conda install r-r2dii.analysis
```

It is possible to list all of the versions of `r-r2dii.analysis` available on your platform with:
